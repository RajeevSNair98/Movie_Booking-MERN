...
const AddMovie = () => {
    ...
    posterUrl:"",releaseDate:"",featured:false})
    ...
    <div>
      <form onSubmit={handleSubmit}>
        ...
        <Box width={'50%'} padding={10} margin={'auto'} display={'flex'}
        flexDirection={'column'} boxShadow={"10px 10px 20px #ccc"}>
              
               <Typography textAlign={'center'} variant='h5' fontFamily={'Poppins'}>
                Add New Movie
                </Typography>
                ...
                <Box display={'flex'}>
                <TextField name='actors' value={actor} onChange={(e)=>setActor(e.target.value)} variant='standard' margin='normal'/>
                <Button   onClick={() => {
                ...
                <Button type='submit' variant='contained' sx={{width:'30%',margin:'auto', bgcolor:"green",":hover":'grey'}}>
                    Add new movie
                </Button>
